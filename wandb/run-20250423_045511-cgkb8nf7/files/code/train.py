...
class ResNet(nn.Module):
    def __init__(self, block, num_blocks, num_classes=10, lda_args=None):
        ...
        #self.projector = nn.Linear(512 * block.expansion, 64)
...
class Solver:
    def __init__(self, dataloaders, model_path, n_classes, lda_args={}, gpu=-1):
        ...
        self.optimizer = optim.AdamW(self.net.parameters(), lr=1e-4, weight_decay=5e-4)
        # self.optimizer = Lamb(
        #    self.net.parameters(),
        #     lr=1e-2,
        ...
        for batch_idx, (inputs, targets) in enumerate(dataloader):
            ...
            if self.use_lda:
                ...
                if not hasComplexEVal:
                    ...
                    #Loss
                    loss = self.criterion(sigma_w_inv_b) + max(0.0, 1.0 - epoch / 30) * nn.CrossEntropyLoss()(ce, targets)
